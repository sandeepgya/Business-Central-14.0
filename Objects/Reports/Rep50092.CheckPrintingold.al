report 50092 "Check - Printing-old"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Objects/RDLC/CheckPrintingold.rdlc';
    Caption = 'Check';
                            ...
                            WITH GenJnlLine DO BEGIN
                                ...
                                IF FoundLast THEN BEGIN
                                   ...
                                   UseCheckNo, gvLineAmtExclTDSWTpaid);
                                    ...
                                    CheckLedgEntry.Amount := gvLineAmtExclTDSWTpaid;
                                END ELSE BEGIN
    ...
    var
        ...
        // TempJnlBankCharges: Record "Jnl. Bank Charges" temporary;
