report 50032 "Sale Invoice-Taxable eInvoice"
{
    // 1. TRI S.S 12.07.17 - New report created for "GST" Functionality.
    DefaultLayout = RDLC;
    RDLCLayout = './Objects/RDLC/SaleInvoiceTaxableeInvoice.rdlc';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(IRNHash; "Sales Invoice Header"."IRN Hash")
            {
            }
            column(AckNo_SalesInvoiceHeader; "Sales Invoice Header"."Ack No.")
            {
            }
            column(AckCancelDate_SalesInvoiceHeader; "Sales Invoice Header"."Ack./Cancel Date")
            {
            }
            ...
            begin
                ...
                //             END;
                //         END ELSE
                //             txtTaxChargeName[recStructureOrderDetails."Calculation Order"] := FORMAT(recStructureOrderDetails."Tax/Charge Type"); //OA.AS Commented
                ...
                IF RecSL.FINDFIRST THEN
                    placeofSupply := RecSL."GST Place of Supply";
