report 50029 "Stock Transfer Shipment No cos"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Objects/RDLC/StockTransferShipmentNocos.rdlc';
    ...
    dataset
    {
        dataitem("Transfer Shipment Header"; "Transfer Shipment Header")
        {
            ...
            dataitem("Transfer Shipment Line"; "Transfer Shipment Line")
            {
                ...
                column(GSTBaseAmount_TransferShipmentLine; '')//"Transfer Shipment Line".)
                {
                }
                ...
                begin
                    ...
                    */
                    ...
                    CLEAR(Text0001);
                    CheckReport.InitTextVariable;
                    //>>OA.SB 13072021 Correction in report
                    CheckReport.FormatNoText(Text0001, ROUND(decTotaAmount1, 0.01, '>'), '');
