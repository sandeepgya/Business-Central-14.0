report 50023 "Inventory Posting Group Value1"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Objects/RDLC/InventoryPostingGroupValue1.rdlc';
    ...
    dataset
    {
        dataitem("Integer"; "Integer")
        {
            ...
            begin
                ...
                Item.RESET;
                ValueEntry.RESET;
                ValueEntry.SETCURRENTKEY("Inventory Posting Group", "Posting Date", "Item Ledger Entry Type", "Item No.", "Source Type", "Source No.");
                InvtPostGrp.RESET;
                        ...
                        IF Item.FINDFIRST THEN
                            REPEAT
                                FOR i := 1 TO ARRAYLEN(PeriodEndDate) DO BEGIN
                                    //Opening
                                    //ValueEntry.SETFILTER("Inventory Posting Group",'%1',Item."Inventory Posting Group");
                                    //IF i = 12 THEN
